...
fun Decl_PROD_1_ACT (Id, LBRACE, RBRACE, TypeDecl, KW_module, ModuleImport, Id_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), TypeDecl_SPAN : (Lex.pos * Lex.pos), KW_module_SPAN : (Lex.pos * Lex.pos), ModuleImport_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.D_Module{name = Id, imports = ModuleImport, decls = TypeDecl})
fun Decl_PROD_2_ACT (Id1, Id2, LBRACE, RBRACE, KW_module, KW_primitive, Id1_SPAN : (Lex.pos * Lex.pos), Id2_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), KW_module_SPAN : (Lex.pos * Lex.pos), KW_primitive_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.D_Primitive{name = Id1, exports = Id2})
fun Decl_PROD_3_ACT (Id, LBRACE, RBRACE, KW_view, MarkViewEntry, Id_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), KW_view_SPAN : (Lex.pos * Lex.pos), MarkViewEntry_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.D_View{name = Id, entries = MarkViewEntry})
fun ModuleImport_PROD_1_ACT (FULL_SPAN : (Lex.pos * Lex.pos)) = 
  ([])
fun ModuleImport_PROD_2_ACT (Import, LPAREN, RPAREN, Import_SPAN : (Lex.pos * Lex.pos), LPAREN_SPAN : (Lex.pos * Lex.pos), RPAREN_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (Import)
...
fun TypeDef_PROD_3_ACT (Fields, LPAREN, RPAREN, Fields_SPAN : (Lex.pos * Lex.pos), LPAREN_SPAN : (Lex.pos * Lex.pos), RPAREN_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (fn id => PT.TD_Product{name = id, fields = Fields})
fun QualId_PROD_1_ACT (TyId, TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (NONE, TyId)
fun QualId_PROD_2_ACT (Id, DOT, TyId, Id_SPAN : (Lex.pos * Lex.pos), DOT_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (SOME Id, TyId)
...
fun optFields_PROD_1_ACT (FULL_SPAN : (Lex.pos * Lex.pos)) = 
  ([])
fun optFields_PROD_2_ACT (Fields, LPAREN, RPAREN, Fields_SPAN : (Lex.pos * Lex.pos), LPAREN_SPAN : (Lex.pos * Lex.pos), RPAREN_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (Fields)
...
fun ViewEntry_PROD_1_ACT (LEQ, ViewProps, ViewEntities, LEQ_SPAN : (Lex.pos * Lex.pos), ViewProps_SPAN : (Lex.pos * Lex.pos), ViewEntities_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntry(ViewEntities, ViewProps))
fun ViewEntry_PROD_2_ACT (Id, LEQ, LBRACE, RBRACE, MarkViewEntityCode, Id_SPAN : (Lex.pos * Lex.pos), LEQ_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), MarkViewEntityCode_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
...
fun ViewEntity_PROD_3_ACT (Id, DOT, TyId, Id_SPAN : (Lex.pos * Lex.pos), DOT_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntity_Type(Id, TyId))
fun ViewEntity_PROD_4_ACT (Id, DOT1, DOT2, TyId, SEQUENCE, Id_SPAN : (Lex.pos * Lex.pos), DOT1_SPAN : (Lex.pos * Lex.pos), DOT2_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), SEQUENCE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
  (PT.VEntity_AllCons(Id, TyId))
fun ViewEntity_PROD_5_ACT (Id, DOT1, DOT2, TyId, ConId, Id_SPAN : (Lex.pos * Lex.pos), DOT1_SPAN : (Lex.pos * Lex.pos), DOT2_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), ConId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)) = 
...
fun ViewEntity_NT (strm) = let
      ...
      fun ViewEntity_PROD_3 (strm) = let
            ...
            in
              (UserCode.ViewEntity_PROD_3_ACT (Id_RES, DOT_RES, TyId_RES, Id_SPAN : (Lex.pos * Lex.pos), DOT_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun ViewEntity_PROD_4 (strm) = let
            ...
            in
              (UserCode.ViewEntity_PROD_4_ACT (Id_RES, DOT1_RES, DOT2_RES, TyId_RES, SEQUENCE_RES, Id_SPAN : (Lex.pos * Lex.pos), DOT1_SPAN : (Lex.pos * Lex.pos), DOT2_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), SEQUENCE_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun ViewEntity_PROD_5 (strm) = let
            ...
            in
              (UserCode.ViewEntity_PROD_5_ACT (Id_RES, DOT1_RES, DOT2_RES, TyId_RES, ConId_RES, Id_SPAN : (Lex.pos * Lex.pos), DOT1_SPAN : (Lex.pos * Lex.pos), DOT2_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), ConId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun ViewEntry_NT (strm) = let
      fun ViewEntry_PROD_1 (strm) = let
            ...
            in
              (UserCode.ViewEntry_PROD_1_ACT (LEQ_RES, ViewProps_RES, ViewEntities_RES, LEQ_SPAN : (Lex.pos * Lex.pos), ViewProps_SPAN : (Lex.pos * Lex.pos), ViewEntities_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun ViewEntry_PROD_2 (strm) = let
            ...
            in
              (UserCode.ViewEntry_PROD_2_ACT (Id_RES, LEQ_RES, LBRACE_RES, RBRACE_RES, MarkViewEntityCode_RES, Id_SPAN : (Lex.pos * Lex.pos), LEQ_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), MarkViewEntityCode_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun QualId_NT (strm) = let
      ...
      fun QualId_PROD_2 (strm) = let
            ...
            val FULL_SPAN = (#1(Id_SPAN), #2(TyId_SPAN))
            in
              (UserCode.QualId_PROD_2_ACT (Id_RES, DOT_RES, TyId_RES, Id_SPAN : (Lex.pos * Lex.pos), DOT_SPAN : (Lex.pos * Lex.pos), TyId_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun optFields_NT (strm) = let
      ...
      fun optFields_PROD_2 (strm) = let
            ...
            in
              (UserCode.optFields_PROD_2_ACT (Fields_RES, LPAREN_RES, RPAREN_RES, Fields_SPAN : (Lex.pos * Lex.pos), LPAREN_SPAN : (Lex.pos * Lex.pos), RPAREN_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun TypeDef_NT (strm) = let
      ...
      fun TypeDef_PROD_3 (strm) = let
            ...
            val FULL_SPAN = (#1(LPAREN_SPAN), #2(RPAREN_SPAN))
            in
              (UserCode.TypeDef_PROD_3_ACT (Fields_RES, LPAREN_RES, RPAREN_RES, Fields_SPAN : (Lex.pos * Lex.pos), LPAREN_SPAN : (Lex.pos * Lex.pos), RPAREN_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun ModuleImport_NT (strm) = let
      ...
      fun ModuleImport_PROD_2 (strm) = let
            ...
            val FULL_SPAN = (#1(LPAREN_SPAN), #2(RPAREN_SPAN))
            in
              (UserCode.ModuleImport_PROD_2_ACT (Import_RES, LPAREN_RES, RPAREN_RES, Import_SPAN : (Lex.pos * Lex.pos), LPAREN_SPAN : (Lex.pos * Lex.pos), RPAREN_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
...
fun Decl_NT (strm) = let
      fun Decl_PROD_1 (strm) = let
            ...
            in
              (UserCode.Decl_PROD_1_ACT (Id_RES, LBRACE_RES, RBRACE_RES, TypeDecl_RES, KW_module_RES, ModuleImport_RES, Id_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), TypeDecl_SPAN : (Lex.pos * Lex.pos), KW_module_SPAN : (Lex.pos * Lex.pos), ModuleImport_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun Decl_PROD_2 (strm) = let
            ...
            in
              (UserCode.Decl_PROD_2_ACT (Id1_RES, Id2_RES, LBRACE_RES, RBRACE_RES, KW_module_RES, KW_primitive_RES, Id1_SPAN : (Lex.pos * Lex.pos), Id2_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), KW_module_SPAN : (Lex.pos * Lex.pos), KW_primitive_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      fun Decl_PROD_3 (strm) = let
            ...
            in
              (UserCode.Decl_PROD_3_ACT (Id_RES, LBRACE_RES, RBRACE_RES, KW_view_RES, MarkViewEntry_RES, Id_SPAN : (Lex.pos * Lex.pos), LBRACE_SPAN : (Lex.pos * Lex.pos), RBRACE_SPAN : (Lex.pos * Lex.pos), KW_view_SPAN : (Lex.pos * Lex.pos), MarkViewEntry_SPAN : (Lex.pos * Lex.pos), FULL_SPAN : (Lex.pos * Lex.pos)),
                FULL_SPAN, strm')
            end
      in
        (case (lex(strm))
